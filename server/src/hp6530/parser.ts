...
/**
 * Parser states for the HP 6530 escape sequence state machine.
 */
const enum State {
  ...
  ESC,
  /** Inside ESC [ ... (CSI sequence — cursor positioning) */
  CSI,
  /** Inside ESC & ... (attribute sequence) */
  AMP,
  /** Inside ESC & d ... (display attribute — waiting for code byte) */
  AMP_D,
}
